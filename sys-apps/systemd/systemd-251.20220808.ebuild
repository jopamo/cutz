...
inherit bash-completion-r1 flag-o-matic linux-info meson-multilib python-any-r1 systemd toolchain-funcs udev usr-ldscript
...
IUSE="
	...
	fido2 +gcrypt gnuefi gnutls homed http importd iptables +kmod
	+lz4 lzma +openssl pam pcre pkcs11 policykit pwquality qrcode
	+resolvconf +seccomp selinux split-usr +sysv-utils test tpm xkb +zstd
"
REQUIRED_USE="
...
multilib_src_configure() {
	local myconf=(
		...
		-Dpamlibdir="${EPREFIX}/usr/$(get_libdir)/security"
